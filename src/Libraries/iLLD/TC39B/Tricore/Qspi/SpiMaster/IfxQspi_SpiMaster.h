...
typedef struct
{
    uint16  trailingDelay2Prescaler : 3;        /**< \brief Inject the trailing delay for last data */
    uint16  lastTrailingDelay : 3;              /**< \brief Last Trailing delay */
 ...
 * \param handle Module handle
 * \return Latest Capture Timer value (0: if no Capture event occured; Bit15 = 1: if overflow occured)
 */
