...
#define ADBMS6830_AUX_STATUS_CHANNELS_PER_IC (5U)
#define ADBMS6830_AUX_TOTAL_CHANNELS_PER_IC (17U)
...
typedef struct
{
    ...
    uint32_t mV[ADBMS6830_AUX_CHANNELS_PER_IC];
} Adbms6830_AuxData_t;
...
typedef struct
{
    ...
    Adbms6830_AuxStatusData_t auxStatus[ADBMS6830_MAX_ICS];
