...
typedef struct
{
    ...
    uint16_t gpio_voltage_mV[ADBMS6833_SHARED_AFE_COUNT][ADBMS6833_SHARED_USED_CELLS_PER_AFE];
    int16_t cell_temp_raw_0p01C[ADBMS6833_SHARED_AFE_COUNT][ADBMS6833_SHARED_USED_CELLS_PER_AFE];
    uint16_t ic_cell_sum_raw_0p01V[ADBMS6833_SHARED_IC_STATUS_COUNT];
    int16_t ic_internal_temp_raw_0p01C[ADBMS6833_SHARED_IC_STATUS_COUNT];
    uint8_t ic_status_valid[ADBMS6833_SHARED_IC_STATUS_COUNT];
