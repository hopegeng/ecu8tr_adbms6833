...
#define LCF_INTVEC0_START 	0x80080000 		//Ray: 2024_02_09: 0x802FE000
#define LCF_INTVEC1_START 	0x802FC000
#define LCF_INTVEC2_START 	0x802FE000

#define LCF_TRAPVEC0_START  0x80000100
#define LCF_TRAPVEC1_START  0x80100000 		//Ray: 2024_02_09: 0x80300000
#define LCF_TRAPVEC2_START  0x80100100		//Ray: 2024_02_09: 0x80300100

#define LCF_STARTPTR_CPU0 	0x80000000
#define LCF_STARTPTR_CPU1 	0x80100200		//Ray: 2024_02_09: 0x80300200
#define LCF_STARTPTR_CPU2 	0x80100220		//Ray: 2024_02_09: 0x80300220

#define LCF_STARTPTR_NC_CPU0 0xA0000000
#define LCF_STARTPTR_NC_CPU1 0xA0100200		//Ray: 2024_02_09: 0xA0300200
#define LCF_STARTPTR_NC_CPU2 0xA0100220		//Ray: 2024_02_09: 0xA0300220
...
#        endif
    ...
    {
        /*Relative A0 Addressable Data, selectable by toolchain*/
        group NC_CPU0_DLMU( ordered, contiguous, align = 4, attributes=rw, run_addr=mem:cpu0_dlmu/not_cached )
        {
        	select "NC_cpu0_dlmu";
        }
    }    
